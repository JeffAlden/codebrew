            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ms-auto align-items-center">
                    <li className="nav-item">
                        <ScrollLink className="nav-link text-nowrap" to="about" smooth={true} duration={500} name="about">
                            About
                        </ScrollLink>
                    </li>
                    <li className="nav-item">
                        <ScrollLink className="nav-link text-nowrap" to="services" smooth={true} duration={500} name="services">
                            Services
                        </ScrollLink>
                    </li>
                    <li className="nav-item">
                        <ScrollLink className="nav-link text-nowrap" to="products" smooth={true} duration={500} name="products">
                            Products
                        </ScrollLink>
                    </li>
                    <li className="nav-item">
                        <ScrollLink className="nav-link text-nowrap" to="contact" smooth={true} duration={500} name="contact">
                            Contact Us
                        </ScrollLink>
                    </li>
